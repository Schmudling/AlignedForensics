DATASET="/nobackup/anirudh/datasets/corvi_ldm_inv"
SHADERS_21K="/nobackup/anirudh/datasets/Shaders21k/shaders_inv"



LDM_NAME="ldm/corvi_ldm_flex/"
LDM_DS_NAME="s10_datasize_ablations_s17/corvi_inv_1k_sync"
